...
public class Logic
{
    ...
    public void objectsSetUP()
    {
        ...
        ground = new Ground(groundStartX, groundWidth, getBounderies().getScreenHeight());
    ...
    public void tick(Long now)
    {
        ...
        // Clear screen
        Logic.gc.fillRect(0, 0, Logic.getBounderies().getScreenWidth(), Logic.getBounderies().getScreenHeight());
        ...
        if (playerDied == false)
        {
            if ((now - last1000Millisecond) > 1000 * 1_000_000)
            {
                ...
                if (first.getCurrentY() > -1 * getBounderies().getScreenHeight() * ObstacleFactory.bufferScreens)
                {
                    obstaclesBlocks.addFirst(obstacleFactory.generateBlock());
                    System.out.println("Generated new block: " + obstaclesBlocks.peekFirst().getCurrentY());
                }
    ...
    static public Bounderies getBounderies()
    {
        ...
        {
            bounderiesOBJ = new Bounderies(Logic.gc.getCanvas().getWidth(), Logic.gc.getCanvas().getHeight());
        }
    ...
    static public class Bounderies
    {
        ...
        private final double groundStartX, groundWidth, groundEndX, laneWidth, screenWidth, screenHeight;
        ...
        public Bounderies(double screenWidth, double screenHeight)
        {
            ...
            System.out.println((1 - groundPaddingPercentage * 2) * MadRunner.minScreenX);
            System.out.println(screenWidth);
            if ((1 - groundPaddingPercentage * 2) * screenWidth <= MadRunner.minScreenX)
            {
                this.groundStartX = 0;
        ...
        public double getGroundStartX()
        {
            return this.groundStartX;
        }
        public double getGroundEndX()
        {
            return this.groundEndX;
        }
