...
public class TrailerWithRamp extends Obstacle
{
    ...
    {
        this(lane, ((int)(Math.random() * Trailer.maxNumberOfTrailers) + 1) * Trailer.singleTrailerLength + rampSize);
    }
     ...
     * @param lane new lane
     */
    @Override public void setLane(Block.Lane lane)
    {
        super.setLane(lane);
        this.trailer.setLane(lane);
        this.ramp.setLane(lane);
        this.ramp.setImage(new Image(getClass().getClassLoader().getResourceAsStream("images/obstacles/ramp.png"),
